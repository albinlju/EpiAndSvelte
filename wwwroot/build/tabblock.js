var tabblock = (function () {
    ...
    /* Views\Shared\SvelteComponents\Spinner.svelte generated by Svelte v3.55.1 */

    const file$1 = "Views\\Shared\\SvelteComponents\\Spinner.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 5, 4, 182);
    			attr_dev(div0, "class", "spinner-border animate-spin inline-block w-8 h-8 border-4 text-blue-600 rounded-full");
    			attr_dev(div0, "role", "status");
    			add_location(div0, file$1, 1, 2, 50);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "flex justify-center items-center p-20");
    			add_location(div, file, 90, 2, 2734);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 25, 6, 792);
    			add_location(li0, file, 24, 4, 780);
    			...
    			add_location(button1, file, 35, 6, 1100);
    			add_location(li1, file, 34, 4, 1088);
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div1 = element("div");
    			div0 = element("div");
    			add_location(div0, file, 63, 8, 2007);
    			...
    			add_location(div1, file, 57, 6, 1809);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(57:4) {#if activeDescription == 1}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div1 = element("div");
    			div0 = element("div");
    			add_location(div0, file, 74, 8, 2329);
    			...
    			add_location(div1, file, 68, 6, 2125);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(68:4) {#if activeDescription == 2}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 79, 6, 2445);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(79:4) {#if activeDescription == 3}",
    		ctx
    	});
